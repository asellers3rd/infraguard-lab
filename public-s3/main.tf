...
#   - Added aws_s3_bucket_server_side_encryption_configuration (AES-256)
...
# FIX 3: Enable server-side encryption at rest (CIS AWS 2.1.1 / Trivy AVD-AWS-0132).
# AES-256 (SSE-S3) requires no additional key management overhead; upgrade to
# aws:kms if your compliance posture requires customer-managed keys (CMK).
